...
export const BOT_NAME = '𝗠𝗜𝗡𝗜 𝗥𝗢𝗔𝗡 𝗠𝗗';
export const DEV_NAME = '𝗠𝗥 𝗥𝗢𝗔𝗡';

export const MENU_IMAGE   = 'https://i.postimg.cc/wT00TRdw/5ff0e9bd9817c9be5baab53ef8ee054d.jpg';
export const MENU_IMAGE_2 = 'https://i.postimg.cc/kXdktbZ0/7b0cb31a546cd85d60ad38415370b5ed.jpg';
export const MENU_IMAGES  = [MENU_IMAGE, MENU_IMAGE_2];
export const NEWSLETTER_JID  = '120363410329655506@newsletter'; //<== No change 
export const NEWSLETTER_NAME = '𝗠𝗜𝗡𝗜 - 𝗥𝗢𝗔𝗡';

// ─── OWNER INFO (édite ces valeurs avec tes vraies infos) ───────────────────
export const OWNER_NUMBER  = '237689301479';            // sans +, sans espaces
export const OWNER_NAME    = '𝗠𝗥 𝗥𝗢𝗔𝗡';
export const OWNER_WA      = '*https://wa.me/237689301479*';
export const OWNER_TG      = '*https://t.merRoanInc*';
export const OWNER_GITHUB  = '*https://github.com/MrRoanInc*';
export const REPO_URL      = '*https://github.com/MrRoanInc/Onyxx*';
export const BOT_VERSION   = 'V1.0';

export const WA_CHANNELS = [
  '*https://whatsapp.com/channel/0029VbDIPn19sBI2oMXdO20M',
  
];

export const WA_GROUPS = [
  '*https://chat.whatsapp.com/Ht2NmJr9DoC0RyrnKvSZ5w*',
];
...
// ─────────────────────────────────────────────────────────────────────────────
const MENU_GROUPS = {
    '🧠 ᴀɪ ᴍʏsᴛɪǫᴜᴇ (ʟ𝟷𝟶 ʙʀᴀɪɴ)': { emoji: '⚡', cmds: ['ai','gpt','gpt4','gpt5','metaai','codeai','photoai','storyai','triviaai','deepseek','grok-ai','qwen','gemini'] },
    '🔗 ᴄᴏɴɴᴇxɪᴏɴ ᴏᴄᴄᴜʟᴛᴇ': { emoji: '🌌', cmds: ['pair','connect','bot'] },
    '⚽ ᴄʟᴜʙ & ɢʀᴏᴜᴘᴇ (ᴛᴇᴀᴍ)': { emoji: '⚽', cmds: ['tagall','hidetag','tagadmins','promote','demote','kick','add','mute','unmute','left','grouplink','resetlink','kickadmins','kickall','listadmins','listonline','opentime','closetime','antilink','vcf','creategroup','join','closegc','opengc','warn','warns','resetwarn'] },
    '👑 ᴘᴏᴜᴠᴏɪʀ ᴅᴜ ᴄᴀᴘɪᴛᴀɪɴᴇ (ᴏᴡɴᴇʀ)': { emoji: '🔱', cmds: ['owner','repo','setpp','setprefix','restart','eval','ban','unban','self','public','autoread','autobio','autorecording','autotyping','autoviewstatus','autoreact','block','unblock','delete','setaccount','addsudo','delsudo','listsudo','fixowner','getbot','broadcast','mode','ping','alive','runtime'] },
    '🔮 ᴅɪᴠᴇʀᴛɪssᴇᴍᴇɴᴛ & ᴍᴀɢɪᴇ (ғᴜɴ)': { emoji: '🃏', cmds: ['truth','dare','joke','meme','ship','rate','flirt','roast','compliment','wouldyou','8balladvice','urban','moviequote','triviafact','inspire','ascii','progquote','dadjoke','funfact','paptt'] },
    '🏆 ʟᴇ ᴛᴇʀʀᴀɪɴ ᴅᴇ ᴊᴇᴜ (ɢᴀᴍᴇ)': { emoji: '🏆', cmds: ['rps','rpsls','dice','coin','coinbattle','numberbattle','numbattle','hangman','tictactoe','guess','math','emojiquiz','gamefact','toimg','take','steal','wm','qc'] },
    '🎧 ᴠɪʙʀᴀᴛɪᴏɴs & sᴏɴs': { emoji: '🎧', cmds: ['bass','blown','deep','earrape','fast','nightcore','reverse','robot','slow','smooth','squirrel','tts','say'] },
    '📨 ᴇᴍᴀɪʟs ғᴀɴᴛᴏ̂ᴍᴇs (ᴛᴇᴍᴘ)': { emoji: '📨', cmds: ['newmail','readmail','deltmp','tempmail2','tempmail-inbox'] },
    '⚙️ ᴀʀsᴇɴᴀʟ & ᴏᴜᴛɪʟs': { emoji: '⚙️', cmds: ['weatherwiki','currency','time','qrcode','readqr','shorturl','myip','iplookup','jid','getpp','github','npm','ffstalk','npmstalk','imbd','dictionary','recipe','book','remind','calculate','mathfact','sciencefact','recipe-ingredient','horoscope','password','genpass','readmore','lidch','react-ch','translate','lyrics','afk','removebg','upscale','savestatus'] },
    '👁️ ɪᴍᴀɢᴇs ᴀʟᴇ́ᴀᴛᴏɪʀᴇs': { emoji: '👁️', cmds: ['sfw','moe','aipic','hentai','chinagirl','bluearchive','boypic','carimage','random-girl','hijab-girl','indonesia-girl','japan-girl','korean-girl','loli','malaysia-girl','profile-pictures','tiktokgirl'] },
    '🕵️ ᴛʀᴀǫᴜᴇ (sᴛᴀʟᴋ ᴍᴇɴᴜ)': { emoji: '🕵️', cmds: ['ffstalk','npmstalk','github'] },
    '💰 ᴄᴏɴᴛʀᴀᴛs & ᴘᴀɪᴇᴍᴇɴᴛ': { emoji: '💰', cmds: ['aza','account','setaccount'] },
    '💮 ᴜɴɪᴠᴇʀs ᴀɴɪᴍᴇ': { emoji: '🔮', cmds: ['achar','aquote','arecommend','asearch','loli','maid','megumin','neko','shinobu','waifu'] },
    '🌀 ᴄᴏɴᴠᴇʀsɪᴏɴ ᴍᴀɢɪǫᴜᴇ': { emoji: '🌀', cmds: ['telegraph','url','sticker'] },
    '📥 ᴛᴇ́ʟᴇ́ᴄʜᴀʀɢᴇᴍᴇɴᴛ (ɢᴏʟᴅᴇɴ ʙᴏᴏᴛ)': { emoji: '📥', cmds: ['apk','edit','fb','git','gitclone','insta','mega','mp4','pint','play','song','video','yta','ytmp3','ytv','tiktok','spotify'] },
};

// Set de toutes les commandes connues — sert au déclenchement sans préfixe
export const KNOWN_CMDS = (() => {
  const s = new Set(['menu','help','list','ping','alive','runtime','uptime','del','prefix']);
...
function buildMenu(userName = '') {
  ...
  for (const [title, group] of Object.entries(MENU_GROUPS)) {
    const { emoji, cmds } = group;
    body += `\n┌──────────────────────▢\n│ ${emoji} *${title}*\n├──────────────────────\n`;
    for (let i = 0; i < cmds.length; i += 2) {
      const left = `${emoji} ${PREFIX}${cmds[i]}`;
      const right = cmds[i + 1] ? `${emoji} ${PREFIX}${cmds[i + 1]}` : '';
      body += right
        ? `│ *${left.padEnd(14)}│ ${right}*\n`
        : `│ *${left}*\n`;
    }
    body += `└──────────────────────▢\n`;
  }
...
> 🔮 𝐔𝐒𝐄𝐑 : ${userName || 'You'}
> 👑 𝐃𝐄𝐕 : ${DEV_NAME}
> 🔱 𝐏𝐑𝐄𝐅𝐈𝐗 : [ ${PREFIXES.join(', ')} ]
╰━━━━━━━━━━━━━━━━━━━━╯

🌌*«𝗟𝗲 𝗚𝗢𝗔𝗧 𝗻𝗲 𝗽𝗮𝗿𝗹𝗲 𝗽𝗮𝘀, 𝗶𝗹 𝗹𝗮𝗶𝘀𝘀𝗲 𝘀𝗲𝘀 𝗮𝗰𝘁𝗶𝗼𝗻𝘀 𝗿𝗲́𝗽𝗼𝗻𝗱𝗿𝗲.»*

${body}
╭─〔 ⭐ 𝗠𝗜𝗡𝗜 - 𝗥𝗢𝗔𝗡 ¹⁰ ⭐ 〕
│ 𝐓𝐇𝐄 𝐆𝐎𝐀𝐓 𝐎𝐅 𝐁𝐎𝐓𝐒
│ 𝐅𝐚𝐬𝐭 • 𝐒𝐭𝐚𝐛𝐥𝐞 • 𝐈𝐧𝐭𝐞𝐥𝐥𝐢𝐠𝐞𝐧𝐭
│ 𝐏𝐎𝐖𝐄𝐑𝐄𝐃 𝐁𝐘 ${DEV_NAME}
╰━━━━━━━━━━━━━━━━━━━╯`;
}
...
> *📱 ᴜsᴀɢᴇ:*
➜ *${PREFIX}${cmd} 237xxxxxxxx*
> *ᴇxᴀᴍᴘʟᴇ:*
➜ *${PREFIX}${cmd} 237684683548*
━━━━━━━━━━━━━━━━━━
> *ʀᴜʟᴇs:*
...
> *👑 ᴘᴏᴡᴇʀᴇᴅ ʙʏ : ${DEV_NAME}*`);
        ...
        if (phone.startsWith('0')) {
          await reply(`*❌ ʀᴇᴍᴏᴠᴇ ᴛʜᴇ ʟᴇᴀᴅɪɴɢ 0. ᴇx: ${PREFIX}${cmd} 237xxxx*`);
          break;
        }
...
> *ᴘᴏᴡᴇʀᴇᴅ ʙʏ : ${DEV_NAME}*`);
      ...
      case 'kickadmins': case 'kickall': {
        ...
        if (!isGroupAdmin(admins, senderJid) && !msg.key.fromMe) { await reply('*❌ ᴀᴅᴍɪɴs ᴏɴʟʏ.*'); break; }
      ...
      case 'opentime': case 'closetime': {
        ...
        if (!isGroup(jid) || !mins) { await reply(`*❌ ᴜsᴀɢᴇ: ${PREFIX}${cmd} <ᴍɪɴᴜᴛᴇs>*`); break; }
      ...
      case 'fixowner': { await reply(`👑 𝗢𝘄𝗻𝗲𝗿: *${DEV_NAME}*\n📞 𝗕𝗼𝘁: +${(natsu.user?.id || '').split(':')[0]}`); break; }
      ...
      case 'mode': { const s = getState(); await reply(`⚙️ 𝗠𝗼𝗱𝗲: *${s.mode}*`); break; }
      case 'ping': {
